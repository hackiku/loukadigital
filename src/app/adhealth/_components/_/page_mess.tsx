				...
				<div className="max-w-7xl mx-auto">
					...
					<div className="mb-16">
						<h2 className="text-4xl md:text-5xl lg:text-5xl font-bold mb-8 leading-tight">
							...
							on Earth does my{' '} <br className="hidden sm:block" />
					...
					<div className="max-w-lg mb-12">
						<p className="text-2xl md:text-3xl text-muted-foreground leading-relaxed mb-4">
							...
							<span className="px-2 md:px-4 py-1 md:py-1 bg-red-500/20 rounded-full border-2 border-red-500/40">
								<span className="font-black text-red-400">40% +</span>
							</span>{' '} <br />
							<span className="font-bold text-foreground">ad budget </span>
							on issues that are easy to fix, yet <span className="font-semibold italic text-foreground underline">devilish to diagnose</span>.
							That's why we often call them...
						</p>
					</div>
